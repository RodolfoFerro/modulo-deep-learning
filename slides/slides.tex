        ...
        \begin{columns}
            ...
            \begin{column}{0.7\textwidth}
                ...
                {\scriptsize \begin{itemize}
                    \item Sr. Machine Learning | Computer Vision Engineer @ AIAEC
                    \item Facilitador DS/AI @ DECI ENES León (UNAM) \& EdgeHub School of Innovation.
                    \item \textbf{Formación:} Esp. en Métodos Estadísticos (c/enf. en DS) @ CIMAT, BMath (UG), CSysEng (UVEG)
                    \item \textbf{Experiencia:} Sr. SWE @ Bisconic (US), ML Engineer @ Vindoo.ai (España), Sherpa Digital de IA @ Microsoft México, AI Research Assistant @ CIMAT \& AI Research Intern @ Harvard.
                \end{itemize}}
            \end{column}
            % Columna derecha
