    ...
    \begin{frame}{El perceptrón multicapa}{Intro al aprendizaje profundo}
        ...
        \begin{center}
            \begin{tikzpicture}[x=2.4cm,y=1	.2cm]
                ...
                % LABELS
                \node[above=3,align=center,mydarkgreen] at (N1-1.90) {Capa de \\[-0.2em]entrada};
                \node[above=2,align=center,mydarkblue] at (N2-1.90) {Capas\\[-0.2em]ocultas};
                \node[above=3,align=center,mydarkred] at (N\Nnodlen-1.90) {Capa de\\[-0.2em]salida};
